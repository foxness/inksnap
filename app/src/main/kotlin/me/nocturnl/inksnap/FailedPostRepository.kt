...
class FailedPostRepository private constructor(context_: Context)
{
    private val failedPostDao = AppDatabase.getInstance(context_.applicationContext).failedPostDao()
